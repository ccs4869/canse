  ...
  <div class="login-container">
    ...
    >
      ...
      <el-form-item style="text-align: center">
        <el-button :dark="isDark" plain @click="onLogin"> 登陆 </el-button>
        <el-button @click="toRegister" plain> 注册 </el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
const onLogin = () => {
  ...
  request.postLogin(stringify(loginForm)).then((res) => console.log(res))
  router.push("/user")
}
...
const toRegister = () => {
  store.switchRegistCom()
  console.log(store.componentId)
}
</script>
